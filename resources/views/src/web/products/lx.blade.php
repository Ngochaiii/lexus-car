                    ...
                    <div class="product-gallery">
                        <div class="gallery-main-wrap">
                            ...
                            <div class="gallery-main">
                                <img fetchpriority="high" loading="eager" decoding="async" src="{{ asset_v('web/assets/images/lx/anh-main.webp') }}"
        ...
        <div class="container">
            <div class="intro-grid">
                <div class="intro-img-wrap">
                    <img loading="lazy" decoding="async" src="{{ asset_v('web/assets/images/lx/intro.jpg') }}"
        ...
        <div class="container">
            ...
            <div class="colour-pane active" id="ct-exterior">
                <div class="tech-grid">
                    <div class="tech-item">
                        <div class="ti-content">
                            <div class="feature-thumb-img">
                                <img loading="lazy" decoding="async" src="{{ asset_v('web/assets/images/lx/mau-den.webp') }}" alt="Màu đen">
                            </div>
                    ...
                    <div class="tech-item">
                        <div class="ti-content">
                            <div class="feature-thumb-img">
                                <img loading="lazy" decoding="async" src="{{ asset_v('web/assets/images/lx/mau-trang.webp') }}" alt="Màu trắng">
                            </div>
                    ...
                    <div class="tech-item">
                        <div class="ti-content">
                            <div class="feature-thumb-img">
                                <img loading="lazy" decoding="async" src="{{ asset_v('web/assets/images/lx/mau-xam.jpg') }}" alt="Màu xám">
                            </div>
            ...
            <div class="colour-pane" id="ct-wheels">
                ...
                <div class="item-grid-3">
                    <div class="item-card active" onclick="selectCard(this)">
                        <img loading="lazy" decoding="async" src="{{ asset_v('web/assets/images/lx/mam-urban.webp') }}" alt="Mâm 22 inch Urban">
                    ...
                    <div class="item-card" onclick="selectCard(this)">
                        <img loading="lazy" decoding="async" src="{{ asset_v('web/assets/images/lx/mam-fsport.webp') }}" alt="Mâm 22 inch F SPORT">
                    ...
                    <div class="item-card" onclick="selectCard(this)">
                        <img loading="lazy" decoding="async" src="{{ asset_v('web/assets/images/lx/mam-vip.jpg') }}" alt="Mâm 22 inch VIP">
            ...
            <div class="colour-pane" id="ct-seat">
                ...
                <div class="item-grid-4">
                    <div class="item-card active" onclick="selectCard(this)">
                        <img loading="lazy" decoding="async" src="{{ asset_v('web/assets/images/lx/ghe-den.png') }}" alt="Ghế đen">
                        <div class="item-card-label">Đen black</div>
                    </div>
                    <div class="item-card" onclick="selectCard(this)">
                        <img loading="lazy" decoding="async" src="{{ asset_v('web/assets/images/lx/ghe-nau.png') }}" alt="Ghế nâu">
                        <div class="item-card-label">Nâu Sunflare Brown</div>
                    </div>
                    <div class="item-card" onclick="selectCard(this)">
                        <img loading="lazy" decoding="async" src="{{ asset_v('web/assets/images/lx/ghe-trang.png') }}" alt="Ghế trắng">
                        <div class="item-card-label">Trắng White & Dark Sepia</div>
                    </div>
                    <div class="item-card" onclick="selectCard(this)">
                        <img loading="lazy" decoding="async" src="{{ asset_v('web/assets/images/lx/ghe-hazel.png') }}" alt="Ghế Hazel">
                        <div class="item-card-label">Nâu Hazel</div>
                    </div>
                    <div class="item-card" onclick="selectCard(this)">
                        <img loading="lazy" decoding="async" src="{{ asset_v('web/assets/images/lx/ghe-den2.png') }}" alt="Ghế đen 2">
                        <div class="item-card-label">Đen black</div>
                    </div>
                    <div class="item-card" onclick="selectCard(this)">
                        <img loading="lazy" decoding="async" src="{{ asset_v('web/assets/images/lx/ghe-crimson.png') }}" alt="Ghế Crimson">
                        <div class="item-card-label">Đổ thẫm Crimson</div>
                    </div>
                    <div class="item-card" onclick="selectCard(this)">
                        <img loading="lazy" decoding="async" src="{{ asset_v('web/assets/images/lx/ghe-do.png') }}" alt="Ghế đỏ">
            ...
            <div class="colour-pane" id="ct-trim">
                ...
                <div class="item-grid-3">
                    <div class="item-card active" onclick="selectCard(this)">
                        <img loading="lazy" decoding="async" src="{{ asset_v('web/assets/images/lx/op-go.jpg') }}" alt="Ốp gỗ VIP">
                        <div class="item-card-label">Ốp gỗ sang trọng<br><span
                                style="color:var(--lexus-gold);font-size:0.7rem;">Phiên bản LX 600 VIP</span></div>
                    </div>
                    <div class="item-card" onclick="selectCard(this)">
                        <img loading="lazy" decoding="async" src="{{ asset_v('web/assets/images/lx/op-nhom.webp') }}" alt="Ốp nhôm Hadori F SPORT">
    ...
    <section class="powertrain-section section-padding" id="powertrain">
        <div class="container">
            ...
            <div class="variant-pane active" id="vt-engine">
                <div class="powertrain-grid">
                    <div class="powertrain-image">
                        <img loading="lazy" decoding="async" src="{{ asset_v('web/assets/images/lx/dong-co.webp') }}" alt="Động cơ LX 600 3.5L V6 Twin Turbo">
            ...
            <div class="variant-pane" id="vt-transmission">
                <div class="powertrain-grid">
                    <div class="powertrain-image">
                        <img loading="lazy" decoding="async" src="{{ asset_v('web/assets/images/lx/hop-so.jpg') }}" alt="Hệ dẫn động 4 bánh LX 600">
            ...
            <div class="chassis-grid">
                <div class="chassis-images">
                    <div class="chassis-img-card">
                        <img loading="lazy" decoding="async" src="{{ asset_v('web/assets/images/lx/treo-avs.jpg') }}"
                    ...
                    <div class="chassis-img-card">
                        <img loading="lazy" decoding="async" src="{{ asset_v('web/assets/images/lx/treo-ahc.webp') }}"
                ...
                <div class="chassis-diagram">
                    <div class="chassis-diagram-img">
                        <img loading="lazy" decoding="async" src="{{ asset_v('web/assets/images/lx/khung-gam.webp') }}"
    ...
    <section class="design-section" id="design">
        <div class="container">
            ...
            <div class="design-pane active" id="dp-exterior">
                <div class="design-row">
                    <div class="design-card">
                        <img loading="lazy" decoding="async" src="{{asset_v('web/assets/images/lx/ngoai-that-fsport.webp')}}"
                    ...
                    <div class="design-card">
                        <img loading="lazy" decoding="async" src="{{asset_v('web/assets/images/lx/ngoai-that-urban.webp')}}"
                    ...
                    <div class="design-card wide">
                        <img loading="lazy" decoding="async" src="{{asset_v('web/assets/images/lx/ngoai-that-ben.jpg')}}"
            ...
            <div class="design-pane" id="dp-interior">
                <div class="design-row">
                    <div class="design-card wide">
                        <img loading="lazy" decoding="async" src="{{asset_v('web/assets/images/lx/noi-that-1.jpg')}}"
                    ...
                    <div class="design-card">
                        <img loading="lazy" decoding="async" src="{{asset_v('web/assets/images/lx/noi-that-urban.webp')}}"
                    ...
                    <div class="design-card">
                        <img loading="lazy" decoding="async" src="{{asset_v('web/assets/images/lx/noi-that-fsport.webp')}}"
            ...
            <div class="design-pane" id="dp-vip">
                <div class="design-row">
                    <div class="design-card wide">
                        <img loading="lazy" decoding="async" src="{{asset_v('web/assets/images/lx/vip-1.jpg')}}"
                    ...
                    <div class="design-card">
                        <img loading="lazy" decoding="async" src="{{asset_v('web/assets/images/lx/vip-ghe.jpg')}}"
                    ...
                    <div class="design-card">
                        <img loading="lazy" decoding="async" src="{{asset_v('web/assets/images/lx/vip-rse.jpg')}}"
                ...
                <div class="tech-grid">
                    <div class="tech-item">
                        <div class="ti-content">
                            <a href="{{ route('tech_car.index') }}">
                                <div class="feature-thumb-img">
                                    <img loading="lazy" decoding="async" src="{{ asset_v('web/assets/images/lx/PCS.webp') }}" alt="PCS">
                                </div>
                    ...
                    <div class="tech-item">
                        <div class="ti-content">
                            <a href="{{ route('tech_car.index') }}">
                                <div class="feature-thumb-img">
                                    <img loading="lazy" decoding="async" src="{{ asset_v('web/assets/images/lx/RRCC.webp') }}" alt="DRCC">
                                </div>
                    ...
                    <div class="tech-item">
                        <div class="ti-content">
                            <a href="{{ route('tech_car.index') }}">
                                <div class="feature-thumb-img">
                                    <img loading="lazy" decoding="async" src="{{ asset_v('web/assets/images/lx/LTA.webp') }}" alt="LTA/LDA">
                                </div>
                    ...
                    <div class="tech-item">
                        <div class="ti-content">
                            <a href="{{ route('tech_car.index') }}">
                                <div class="feature-thumb-img">
                                    <img loading="lazy" decoding="async" src="{{ asset_v('web/assets/images/lx/AHB.webp') }}" alt="BladeScan AHS">
                                </div>
                    ...
                    <div class="tech-item">
                        <div class="ti-content">
                            <a href="{{ route('tech_car.index') }}">
                                <div class="feature-thumb-img">
                                    <img loading="lazy" decoding="async" src="{{ asset_v('web/assets/images/lx/BSM.webp') }}" alt="BSM/RCTA">
                                </div>
                    ...
                    <div class="tech-item">
                        <div class="ti-content">
                            <a href="{{ route('tech_car.index') }}">
                                <div class="feature-thumb-img">
                                    <img loading="lazy" decoding="async" src="{{ asset_v('web/assets/images/lx/SEA.webp') }}" alt="Túi khí SRS">
                                </div>
