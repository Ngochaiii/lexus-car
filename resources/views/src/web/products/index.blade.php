...
@push('js')
    <script>
        ...
        const colorGalleries = {
            ...
            blue: {
                name: 'Màu xanh dương',
                images: ['{{ asset_v('web/assets/images/rx/xanhblue.webp') }}',
                    '{{ asset_v('web/assets/images/rx/xanhd1.png') }}',
                    '{{ asset_v('web/assets/images/rx/xanhd2.png') }}',
                    '{{ asset_v('web/assets/images/rx/xanhd3.png') }}',
                    '{{ asset_v('web/assets/images/rx/xanhd4.png') }}'
                ]
            }
        };
