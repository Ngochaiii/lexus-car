                    ...
                    <div class="product-gallery">
                        <div class="gallery-main-wrap">
                            ...
                            <div class="gallery-main">
                                <img fetchpriority="high" loading="eager" decoding="async" src="{{ asset_v('web/assets/images/nx/anh-1.jpg') }}"
        ...
        <div class="container">
            <div class="intro-grid">
                <div class="intro-img-wrap">
                    <img loading="lazy" decoding="async" src="{{ asset_v('web/assets/images/nx/tong-quan.jpg') }}"
        ...
        <div class="container">
            ...
            <div class="colour-pane active" id="ct-exterior">
                <div class="tech-grid">
                    <div class="tech-item">
                        <div class="ti-content">
                            <div class="feature-thumb-img">
                                <img loading="lazy" decoding="async" src="{{ asset_v('web/assets/images/nx/mau-den.jpg') }}" alt="Màu đen">
                            </div>
                    ...
                    <div class="tech-item">
                        <div class="ti-content">
                            <div class="feature-thumb-img">
                                <img loading="lazy" decoding="async" src="{{ asset_v('web/assets/images/nx/mau-trang.jpg') }}" alt="Màu trắng">
                            </div>
                    ...
                    <div class="tech-item">
                        <div class="ti-content">
                            <div class="feature-thumb-img">
                                <img loading="lazy" decoding="async" src="{{ asset_v('web/assets/images/nx/mau-xam.jpg') }}" alt="Màu xám">
                            </div>
                    ...
                    <div class="tech-item">
                        <div class="ti-content">
                            <div class="feature-thumb-img">
                                <img loading="lazy" decoding="async" src="{{ asset_v('web/assets/images/nx/mau-do.jpg') }}" alt="Màu đỏ">
                            </div>
                    ...
                    <div class="tech-item">
                        <div class="ti-content">
                            <div class="feature-thumb-img">
                                <img loading="lazy" decoding="async" src="{{ asset_v('web/assets/images/nx/mau-xanh-reu.jpg') }}" alt="Xanh rêu">
                            </div>
                    ...
                    <div class="tech-item">
                        <div class="ti-content">
                            <div class="feature-thumb-img">
                                <img loading="lazy" decoding="async" src="{{ asset_v('web/assets/images/nx/mau-xanh-duong.jpg') }}" alt="Xanh dương">
                            </div>
            ...
            <div class="colour-pane" id="ct-wheels">
                ...
                <div class="item-grid-3">
                    <div class="item-card active" onclick="selectCard(this)">
                        <img loading="lazy" decoding="async" src="{{ asset_v('web/assets/images/nx/mam-xe-1.jpg') }}" alt="Mâm xe tiêu chuẩn">
                    ...
                    <div class="item-card" onclick="selectCard(this)">
                        <img loading="lazy" decoding="async" src="{{ asset_v('web/assets/images/nx/mam-xe-2.jpg') }}" alt="Mâm xe 20 inch">
            ...
            <div class="colour-pane" id="ct-seat">
                ...
                <div class="item-grid-4">
                    <div class="item-card active" onclick="selectCard(this)">
                        <img loading="lazy" decoding="async" src="{{ asset_v('web/assets/images/nx/ghe-den.jpg') }}" alt="Ghế đen">
                        <div class="item-card-label">Đen & Kem - Black & Rich Cream<br></div>
                    </div>
                    <div class="item-card" onclick="selectCard(this)">
                        <img loading="lazy" decoding="async" src="{{ asset_v('web/assets/images/nx/ghe-trang.jpg') }}" alt="Ghế trắng">
                        <div class="item-card-label">Trắng White (Phiên bản F SPORT)</div>
                    </div>
                    <div class="item-card" onclick="selectCard(this)">
                        <img loading="lazy" decoding="async" src="{{ asset_v('web/assets/images/nx/ghe-nau.jpg') }}" alt="Ghế nâu">
                        <div class="item-card-label">Nâu Hazel</div>
                    </div>
                    <div class="item-card" onclick="selectCard(this)">
                        <img loading="lazy" decoding="async" src="{{ asset_v('web/assets/images/nx/ghe-do1.jpg') }}" alt="Ghế đỏ">
                        <div class="item-card-label">Đỏ Dank ROSE</div>
                    </div>
                    <div class="item-card" onclick="selectCard(this)">
                        <img loading="lazy" decoding="async" src="{{ asset_v('web/assets/images/nx/ghe-do2.jpg') }}" alt="ghế đen black">
                        <div class="item-card-label">Đen - Black</div>
                    </div>
                    <div class="item-card" onclick="selectCard(this)">
                        <img loading="lazy" decoding="async" src="{{ asset_v('web/assets/images/nx/ghe-do3.jpg') }}" alt="ghế đen black">
                        <div class="item-card-label">Đỏ - Flare Red(Phiên bản F SPORT)</div>
                    </div>
                    <div class="item-card" onclick="selectCard(this)">
                        <img loading="lazy" decoding="async" src="{{ asset_v('web/assets/images/nx/ghe-do4.jpg') }}" alt="ghế đen black">
            ...
            <div class="colour-pane" id="ct-trim">
                ...
                <div class="item-grid-3">
                    <div class="item-card active" onclick="selectCard(this)">
                        <img loading="lazy" decoding="async" src="{{ asset_v('web/assets/images/nx/op-1.jpg') }}" alt="Ốp gỗ">
                        <div class="item-card-label">Gỗ Open Pore Ash/Sumi Black Finish<br><span
                                style="color:var(--lexus-gold);font-size:0.7rem;">Phiên bản NX 350h</span></div>
                    </div>
                    <div class="item-card" onclick="selectCard(this)">
                        <img loading="lazy" decoding="async" src="{{ asset_v('web/assets/images/nx/op-2.jpg') }}" alt="Ốp nhôm">
            ...
            <div class="colour-pane" id="ct-wheel">
                ...
                <div class="item-grid-4">
                    <div class="item-card active" onclick="selectCard(this)">
                        <img loading="lazy" decoding="async" src="{{ asset_v('web/assets/images/nx/volang-1.jpg') }}"
                    ...
                    <div class="item-card" onclick="selectCard(this)">
                        <img loading="lazy" decoding="async" src="{{ asset_v('web/assets/images/nx/volang-2.jpg') }}" alt="Vô lăng gỗ kết hợp da">
    ...
    <section class="powertrain-section section-padding" id="powertrain">
        <div class="container">
            ...
            <div class="variant-pane active" id="vt-350">
                <div class="powertrain-grid">
                    <div class="powertrain-image">
                        <img loading="lazy" decoding="async" src="{{ asset_v('web/assets/images/nx/dongco-24l.jpg') }}" alt="Động cơ NX 350 2.4L Turbo AWD">
            ...
            <div class="variant-pane" id="vt-350h">
                <div class="powertrain-grid">
                    <div class="powertrain-image">
                        <img loading="lazy" decoding="async" src="{{ asset_v('web/assets/images/nx/dongco-25l.jpg') }}" alt="Hệ thống Hybrid NX 350h 2.5L HEV">
            ...
            <div class="chassis-grid">
                <div class="chassis-images">
                    <div class="chassis-img-card">
                        <img loading="lazy" decoding="async" src="{{ asset_v('web/assets/images/nx/treo-truoc.jpg') }}"
                    ...
                    <div class="chassis-img-card">
                        <img loading="lazy" decoding="async" src="{{ asset_v('web/assets/images/nx/treo-sau.jpg') }}"
                ...
                <div class="chassis-diagram">
                    <div class="chassis-diagram-img">
                        <img loading="lazy" decoding="async" src="{{ asset_v('web/assets/images/nx/khung-gam.jpg') }}"
    ...
    <section class="design-section" id="design">
        <div class="container">
            ...
            <div class="design-pane active" id="dp-exterior">
                <div class="design-row">
                    <div class="design-card">
                        <img loading="lazy" decoding="async" src="{{asset_v('web/assets/images/nx/mat-truoc.jpg')}}"
                    ...
                    <div class="design-card">
                        <img loading="lazy" decoding="async" src="{{asset_v('web/assets/images/nx/duoi-xe.jpg')}}"
                    ...
                    <div class="design-card wide">
                        <img loading="lazy" decoding="async" src="{{asset_v('web/assets/images/nx/than-xe.jpg')}}"
            ...
            <div class="design-pane" id="dp-interior">
                <div class="design-row">
                    <div class="design-card wide">
                        <img loading="lazy" decoding="async" src="{{asset_v('web/assets/images/nx/cabin.jpg')}}"
                    ...
                    <div class="design-card">
                        <img loading="lazy" decoding="async" src="{{asset_v('web/assets/images/nx/ghe-fsport.jpg')}}"
                    ...
                    <div class="design-card">
                        <img loading="lazy" decoding="async" src="{{asset_v('web/assets/images/nx/bang-dieu-khien.jpg')}}"
            ...
            <div class="design-pane" id="dp-tech">
                <div class="design-row">
                    <div class="design-card">
                        <img loading="lazy" decoding="async" src="{{asset_v('web/assets/images/nx/man-hinh.jpg')}}"
                    ...
                    <div class="design-card">
                        <img loading="lazy" decoding="async" src="{{asset_v('web/assets/images/nx/dong-ho.jpg')}}"
                    ...
                    <div class="design-card wide">
                        <img loading="lazy" decoding="async" src="{{asset_v('web/assets/images/nx/hud.jpg')}}"
                ...
                <div class="tech-grid">
                    ...
                    <div class="tech-item">
                        <div class="ti-content">
                            <a href="{{ route('tech_car.index') }}">
                                <div class="feature-thumb-img">
                                    <img loading="lazy" decoding="async" src="{{ asset_v('web/assets/images/rx/LTA.webp') }}" alt="LDA/LTA">
                                </div>
                    ...
                    <div class="tech-item">
                        <div class="ti-content">
                            <a href="{{ route('tech_car.index') }}">
                                <div class="feature-thumb-img">
                                    <img loading="lazy" decoding="async" src="{{ asset_v('web/assets/images/rx/PKSB.webp') }}" alt="PKSB">
                                </div>
                    ...
                    <div class="tech-item">
                        <div class="ti-content">
                            <a href="{{ route('tech_car.index') }}">
                                <div class="feature-thumb-img">
                                    <img loading="lazy" decoding="async" src="{{ asset_v('web/assets/images/rx/SEA.webp') }}" alt="Túi khí SRS">
                                </div>
