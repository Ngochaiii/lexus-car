                    ...
                    <div class="product-gallery">
                        <div class="gallery-main-wrap">
                            ...
                            <div class="gallery-main">
                                <img fetchpriority="high" loading="eager" decoding="async" src="{{ asset_v('web/assets/images/ls/mau-den.jpg') }}"
        ...
        <div class="container">
            <div class="intro-grid">
                <div class="intro-img-wrap">
                    <img loading="lazy" decoding="async" src="{{ asset_v('web/assets/images/lexus-ls500h-thong-so-tong-quan-1.jpg') }}"
        ...
        <div class="container">
            ...
            <div class="colour-pane active" id="ct-exterior">
                <div class="tech-grid">
                    <div class="tech-item">
                        <div class="ti-content">
                            <div class="feature-thumb-img">
                                <img loading="lazy" decoding="async" src="{{ asset_v('web/assets/images/ls/mau-den.jpg') }}" alt="Màu đen">
                            </div>
                    ...
                    <div class="tech-item">
                        <div class="ti-content">
                            <div class="feature-thumb-img">
                                <img loading="lazy" decoding="async" src="{{ asset_v('web/assets/images/ls/mau-trang.jpg') }}" alt="Màu trắng">
                            </div>
                    ...
                    <div class="tech-item">
                        <div class="ti-content">
                            <div class="feature-thumb-img">
                                <img loading="lazy" decoding="async" src="{{ asset_v('web/assets/images/ls/mau-xam.jpg') }}" alt="Màu xám">
                            </div>
                    ...
                    <div class="tech-item">
                        <div class="ti-content">
                            <div class="feature-thumb-img">
                                <img loading="lazy" decoding="async" src="{{ asset_v('web/assets/images/ls/mau-do.jpg') }}" alt="Màu đỏ">
                            </div>
                    ...
                    <div class="tech-item">
                        <div class="ti-content">
                            <div class="feature-thumb-img">
                                <img loading="lazy" decoding="async" src="{{ asset_v('web/assets/images/ls/mau-xanh.jpg') }}" alt="Xanh Structural">
                            </div>
            ...
            <div class="colour-pane" id="ct-seat">
                ...
                <div class="item-grid-4">
                    <div class="item-card active" onclick="selectCard(this)">
                        <img loading="lazy" decoding="async" src="{{ asset_v('web/assets/images/ls/noi-that-den.jpg') }}" alt="Nội thất đen">
                    ...
                    <div class="item-card" onclick="selectCard(this)">
                        <img loading="lazy" decoding="async" src="{{ asset_v('web/assets/images/ls/noi-that-doden.jpg') }}" alt="Nội thất trắng kem">
                        <div class="item-card-label">Đỏ & đen<br><span
                                style="color:var(--lexus-gold);font-size:0.7rem;">Phong cách sang trọng</span></div>
                    </div>
                    <div class="item-card" onclick="selectCard(this)">
                        <img loading="lazy" decoding="async" src="{{ asset_v('web/assets/images/ls/noi-that-vangnau.jpg') }}" alt="Nội thất nâu">
                        <div class="item-card-label">Vàng nâu<br><span
                                style="color:var(--lexus-gold);font-size:0.7rem;">Phong cách ấm áp</span></div>
                    </div>
                    <div class="item-card" onclick="selectCard(this)">
                        <img loading="lazy" decoding="async" src="{{ asset_v('web/assets/images/ls/noi-that-hatde.jpg') }}" alt="Nội thất xanh navy">
            ...
            <div class="colour-pane" id="ct-trim">
                ...
                <div class="item-grid-3">
                    <div class="item-card active" onclick="selectCard(this)">
                        <img loading="lazy" decoding="async" src="{{ asset_v('web/assets/images/ls/op-1.jpg') }}" alt="Ốp gỗ">
                    ...
                    <div class="item-card" onclick="selectCard(this)">
                        <img loading="lazy" decoding="async" src="{{ asset_v('web/assets/images/ls/op-2.jpg') }}" alt="Ốp nhôm">
                    ...
                    <div class="item-card" onclick="selectCard(this)">
                        <img loading="lazy" decoding="async" src="{{ asset_v('web/assets/images/ls/op-3.jpg') }}" alt="Ốp carbon">
                    ...
                    <div class="item-card" onclick="selectCard(this)">
                        <img loading="lazy" decoding="async" src="{{ asset_v('web/assets/images/ls/op-4.jpg') }}" alt="Ốp carbon">
            ...
            <div class="colour-pane" id="ct-anniversary">
                ...
                <div class="item-grid-3">
                    <div class="item-card active" onclick="selectCard(this)">
                        <img loading="lazy" decoding="async" src="{{ asset_v('web/assets/images/ls/30nam-1.jpg') }}" alt="Phiên bản 30 năm">
                    ...
                    <div class="item-card" onclick="selectCard(this)">
                        <img loading="lazy" decoding="async" src="{{ asset_v('web/assets/images/ls/30nam-2.jpg') }}" alt="Nội thất 30 năm">
                    ...
                    <div class="item-card" onclick="selectCard(this)">
                        <img loading="lazy" decoding="async" src="{{ asset_v('web/assets/images/ls/30nam-3.jpg') }}" alt="Logo 30 năm">
    ...
    <section class="powertrain-section section-padding" id="powertrain">
        <div class="container">
            ...
            <div class="variant-pane active" id="vt-500h">
                <div class="powertrain-grid">
                    <div class="powertrain-image">
                        <img loading="lazy" decoding="async" src="{{ asset_v('web/assets/images/ls/tong-quan-1.jpg') }}" alt="Hệ thống Multi Stage Hybrid LS 500h">
            ...
            <div class="variant-pane" id="vt-500">
                <div class="powertrain-grid">
                    <div class="powertrain-image">
                        <img loading="lazy" decoding="async" src="{{ asset_v('web/assets/images/ls/tong-quan-2.jpg') }}" alt="Động cơ LS 500 V6 Twin Turbo">
            ...
            <div class="chassis-grid">
                <div class="chassis-images">
                    <div class="chassis-img-card">
                        <img loading="lazy" decoding="async" src="{{ asset_v('web/assets/images/ls/treo-truoc.jpg') }}"
                    ...
                    <div class="chassis-img-card">
                        <img loading="lazy" decoding="async" src="{{ asset_v('web/assets/images/ls/treo-sau.jpg') }}"
                ...
                <div class="chassis-diagram">
                    <div class="chassis-diagram-img">
                        <img loading="lazy" decoding="async" src="{{ asset_v('web/assets/images/ls/vdim-ldh.jpg') }}"
    ...
    <section class="design-section" id="design">
        <div class="container">
            ...
            <div class="design-pane active" id="dp-exterior">
                <div class="design-row">
                    <div class="design-card">
                        <img loading="lazy" decoding="async" src="{{asset_v('web/assets/images/ls/dau-xe.jpg')}}"
                            alt="Đầu xe Lexus LS">
                    ...
                    <div class="design-card">
                        <img loading="lazy" decoding="async" src="{{asset_v('web/assets/images/ls/duoi-xe.jpg')}}"
                    ...
                    <div class="design-card wide">
                        <img loading="lazy" decoding="async" src="{{asset_v('web/assets/images/ls/than-xe.jpg')}}"
            ...
            <div class="design-pane" id="dp-interior">
                <div class="design-row">
                    <div class="design-card wide">
                        <img loading="lazy" decoding="async" src="{{asset_v('web/assets/images/ls/volang.jpg')}}"
                    ...
                    <div class="design-card">
                        <img loading="lazy" decoding="async" src="{{asset_v('web/assets/images/ls/can-so.jpg')}}"
                            alt="Cần số Lexus LS">
                        <div class="design-caption">
                    ...
                    <div class="design-card">
                        <img loading="lazy" decoding="async" src="{{asset_v('web/assets/images/ls/tapli-cua.jpg')}}"
            ...
            <div class="design-pane" id="dp-rear">
                <div class="design-row">
                    <div class="design-card wide">
                        <img loading="lazy" decoding="async" src="{{asset_v('web/assets/images/ls/ghe-sau.jpg')}}"
                    ...
                    <div class="design-card">
                        <img loading="lazy" decoding="async" src="{{asset_v('web/assets/images/ls/man-hinh-giai-tri.jpg')}}"
                    ...
                    <div class="design-card">
                        <img loading="lazy" decoding="async" src="{{asset_v('web/assets/images/ls/man-hinh-dieu-khien.jpg')}}"
                ...
                <div class="tech-grid">
                    <div class="tech-item">
                        <div class="ti-content">
                            <a href="{{ route('tech_car.index') }}">
                                <div class="feature-thumb-img">
                                    <img loading="lazy" decoding="async" src="{{ asset_v('web/assets/images/ls/PCS.webp') }}" alt="PCS">
                                </div>
                    ...
                    <div class="tech-item">
                        <div class="ti-content">
                            <a href="{{ route('tech_car.index') }}">
                                <div class="feature-thumb-img">
                                    <img loading="lazy" decoding="async" src="{{ asset_v('web/assets/images/ls/RRCC.webp') }}" alt="DRCC">
                                </div>
                    ...
                    <div class="tech-item">
                        <div class="ti-content">
                            <a href="{{ route('tech_car.index') }}">
                                <div class="feature-thumb-img">
                                    <img loading="lazy" decoding="async" src="{{ asset_v('web/assets/images/ls/LTA.webp') }}" alt="LTA">
                                </div>
                    ...
                    <div class="tech-item">
                        <div class="ti-content">
                            <a href="{{ route('tech_car.index') }}">
                                <div class="feature-thumb-img">
                                    <img loading="lazy" decoding="async" src="{{ asset_v('web/assets/images/ls/AHB.webp') }}" alt="AHS">
                                </div>
                    ...
                    <div class="tech-item">
                        <div class="ti-content">
                            <a href="{{ route('tech_car.index') }}">
                                <div class="feature-thumb-img">
                                    <img loading="lazy" decoding="async" src="{{ asset_v('web/assets/images/ls/BSM.webp') }}" alt="BSM">
                                </div>
                    ...
                    <div class="tech-item">
                        <div class="ti-content">
                            <a href="{{ route('tech_car.index') }}">
                                <div class="feature-thumb-img">
                                    <img loading="lazy" decoding="async" src="{{ asset_v('web/assets/images/pksa.png') }}" alt="PKSA">
                                </div>
                    ...
                    <div class="tech-item">
                        <div class="ti-content">
                            <a href="{{ route('tech_car.index') }}">
                                <div class="feature-thumb-img">
                                    <img loading="lazy" decoding="async" src="{{ asset_v('web/assets/images/puh.png') }}" alt="PUH">
                                </div>
    ...
    <script>
        ...
        const colorGalleries = {
            white: {
                ...
                images: [
                    '{{ asset_v('web/assets/images/ls/mau-trang.jpg') }}',
                    '{{ asset_v('web/assets/images/ls/mau-trang1.jpg') }}',
                    '{{ asset_v('web/assets/images/ls/mau-trang2.jpg') }}',
                    '{{ asset_v('web/assets/images/ls/mau-trang3.jpg') }}',
                    '{{ asset_v('web/assets/images/ls/mau-trang4.jpg') }}'
                ]
            },
            black: {
                name: 'Caviar Black',
                images: [
                    '{{ asset_v('web/assets/images/ls/mau-den.jpg') }}',
                    '{{ asset_v('web/assets/images/ls/mau-den1.jpg') }}',
                    '{{ asset_v('web/assets/images/ls/mau-den2.jpg') }}',
                    '{{ asset_v('web/assets/images/ls/mau-den3.jpg') }}',
                    '{{ asset_v('web/assets/images/ls/mau-den4.jpg') }}'
                ]
            },
            silver: {
                name: 'Sonic Titanium',
                images: [
                    '{{ asset_v('web/assets/images/ls/mau-xam.jpg') }}',
                    '{{ asset_v('web/assets/images/ls/mau-xam1.jpg') }}',
                    '{{ asset_v('web/assets/images/ls/mau-xam2.jpg') }}',
                    '{{ asset_v('web/assets/images/ls/mau-xam3.jpg') }}',
                    '{{ asset_v('web/assets/images/ls/mau-xam4.jpg') }}'
                ]
            },
            red: {
                name: 'Passion Red Mica',
                images: [
                    '{{ asset_v('web/assets/images/ls/mau-do.jpg') }}',
                    '{{ asset_v('web/assets/images/ls/mau-do1.jpg') }}',
                    '{{ asset_v('web/assets/images/ls/mau-do2.jpg') }}',
                    '{{ asset_v('web/assets/images/ls/mau-do3.jpg') }}',
                    '{{ asset_v('web/assets/images/ls/mau-do4.jpg') }}'
                ]
            },
            blue: {
                name: 'Structural Blue',
                images: [
                    '{{ asset_v('web/assets/images/ls/mau-xanh.jpg') }}',
                    '{{ asset_v('web/assets/images/ls/mau-xanh1.jpg') }}',
                    '{{ asset_v('web/assets/images/ls/mau-xanh2.jpg') }}',
                    '{{ asset_v('web/assets/images/ls/mau-xanh3.jpg') }}',
                    '{{ asset_v('web/assets/images/ls/mau-xanh4.jpg') }}'
                ]
            },
        };
