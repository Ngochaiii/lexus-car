...
@push('js')
    <script>
        ...
        const colorGalleries = {
            white: {
                name: 'Màu trắng',
                images: ['{{ asset_v('web/assets/images/lm/mau-trang.jpg') }}',
                    '{{ asset_v('web/assets/images/lm/mau-trang1.jpg') }}',
                    '{{ asset_v('web/assets/images/lm/mau-trang2.jpg') }}',
                    '{{ asset_v('web/assets/images/lm/mau-trang3.jpg') }}',
                    '{{ asset_v('web/assets/images/lm/mau-trang4.jpg') }}'
                ]
            },
            black: {
                name: 'Màu đen',
                images: ['{{ asset_v('web/assets/images/lm/mau-den.jpg') }}',
                    '{{ asset_v('web/assets/images/lm/anh-1.jpg') }}',
                    '{{ asset_v('web/assets/images/lm/anh-2.jpg') }}',
                    '{{ asset_v('web/assets/images/lm/anh-3.jpg') }}',
                    '{{ asset_v('web/assets/images/lm/anh-4.jpg') }}'
                ]
            },
            silver: {
                name: 'Màu xám',
                images: ['{{ asset_v('web/assets/images/lm/mau-xam.jpg') }}',
                    '{{ asset_v('web/assets/images/lm/mau-xam1.jpg') }}',
                    '{{ asset_v('web/assets/images/lm/mau-xam2.jpg') }}',
                    '{{ asset_v('web/assets/images/lm/mau-xam3.jpg') }}',
                    '{{ asset_v('web/assets/images/lm/mau-xam4.jpg') }}'
                ]
            },
            red: {
                name: 'Màu đỏ',
                images: ['{{ asset_v('web/assets/images/lm/mau-do.jpg') }}',
                    '{{ asset_v('web/assets/images/lm/mau-do1.jpg') }}',
                    '{{ asset_v('web/assets/images/lm/mau-do2.jpg') }}',
                    '{{ asset_v('web/assets/images/lm/mau-do3.jpg') }}',
                    '{{ asset_v('web/assets/images/lm/mau-do4.jpg') }}'
                ]
            },
            green: {
                name: 'Màu xanh',
                images: ['{{ asset_v('web/assets/images/lm/mau-xanh.jpg') }}',
                    '{{ asset_v('web/assets/images/lm/mau-xanh1.jpg') }}',
                    '{{ asset_v('web/assets/images/lm/mau-xanh2.jpg') }}',
                    '{{ asset_v('web/assets/images/lm/mau-xanh3.jpg') }}',
                    '{{ asset_v('web/assets/images/lm/mau-xanh4.jpg') }}'
                ]
            },
            blue: {
                name: 'Màu xanh dương',
